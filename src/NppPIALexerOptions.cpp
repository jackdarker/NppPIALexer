...
CNppPIALexerOptions::CNppPIALexerOptions()
{
    // initial values
...
UINT CNppPIALexerOptions::getOptFlags() const
{
    UINT uFlags = 0;
...
bool CNppPIALexerOptions::MustBeSaved() const
{
...
bool CNppPIALexerOptions::IsHtmlCompatible(const TCHAR* szExt) const
{
...
bool CNppPIALexerOptions::IsSupportedFile(const TCHAR* szExt) const
{
...
void CNppPIALexerOptions::ReadOptions(const TCHAR* szIniFilePath)
{
